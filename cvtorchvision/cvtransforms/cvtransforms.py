...
__all__ = ["Compose", "ToTensor", "ToCVImage",
           ...
           "RandomGaussianNoise", "RandomPoissonNoise", "RandomSPNoise","ToTensorNoDiv","NormalizeCaffe"]
...
class NormalizeCaffe(object):
    ...
    def __call__(self, tensor):
        ...
        Returns:
            Tensor: Normalized Tensor image.
        """
        return F.normalizeCaffe(tensor, self.mean,self.std)
